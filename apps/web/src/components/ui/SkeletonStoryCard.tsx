...
export function SkeletonStoryCard() {
  return (
    <motion.div
      className="relative min-w-[260px] max-w-[280px] overflow-hidden rounded-[28px] border border-white/10 bg-gradient-to-b from-white/5 via-transparent to-black/20 p-4"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
